...
export default function Header() {
  ...
  // Use the background detection hook
  const { contrastColor } = useBackgroundDetection({
    sampleHeight: 200,
  ...
  return (
    ...
    >
      ...
      <svg className="w-48 transition-colors duration-300" style={{ fill: contrastColor || 'black' }} viewBox="0 0 1330 124" fill="none" xmlns="http://www.w3.org/2000/svg">
