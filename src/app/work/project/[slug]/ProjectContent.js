  ...
  return (
    <div className="">
        ...
        <div className={` pb-16 z-20 px-4`} style={{ backgroundColor: project.color?.hex || '#fff' }}>
          <div id="project-intro" className="z-20 flex flex-row items-center justify-between h-36 py-6 flex-shrink-0">
            ...
            <div 
              ...
              className="uppercase flex flex-row items-center gap-2 transition-opacity duration-300"
              style={{ opacity: taglineOpacity }}
            >
              {project.tagline} 
              {project.expertise && <span className="font-mono text-xs">{project.expertise.length}</span>}
            </div>
            <div id="project-information-below" className="font-mono uppercase text-xs transition-opacity duration-300" style={{ opacity: taglineOpacity }}>Project Information Below</div>
          </div>    
      ...
      <div className="md:hidden min-h-screen flex flex-col px-4 gap-8 pb-16">
        ...
        {project.projectResults && (
          <div className="big-paragraph font-serif">
            <h3 className="font-mono uppercase text-xs mb-4">( Project Results )</h3>
            <div>
              {project.projectResults.map((block, index) => {
                if (block._type === 'block') {
                  return (
